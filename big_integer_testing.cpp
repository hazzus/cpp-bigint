...
TEST(correctness, add_long) {
    ...
    big_integer c(
        "1000000000000000000000000000000000000000000000000000010000000000000000"
        "0000000000000000000000");
...
TEST(correctness, add_long_signed2) {
    ...
    big_integer b("100000000000000000000000000000000000000");
    big_integer c(
        "-999999999999999999999999999999999999999999999999999900000000000000000"
        "000000000000000000000");
...
TEST(correctness, sub_long) {
    ...
    big_integer b("100000000000000000000000000000000000000");
    big_integer c(
        "9999999999999999999999999999999999999999999999999999900000000000000000"
        "000000000000000000000");
